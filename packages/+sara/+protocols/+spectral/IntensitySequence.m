classdef IntensitySequence < sara.protocols.spectral.ContrastSequence
% INTENSITYSEQUENCE
%
% Description:
...
% -------------------------------------------------------------------------
    ...
    methods
        function obj = IntensitySequence(calibration, varargin)
            obj = obj@sara.protocols.spectral.ContrastSequence(...
        ...
        function stim = generate(obj)
            stim = generate@sara.protocols.spectral.ContrastSequence(obj);
        end
