classdef Steps < patterson.protocols.SpectralProtocol
% STEPS
%
% Description:
    ...
    methods
        ...
        function fName = getFileName(obj)
            if obj.numSteps == 2 && obj.firstContrast < 0
                fName = sprintf('%s_decrement_increment_%us_%ut',...
                    char(obj.spectralClass), obj.stepTime, obj.totalTime);
            else
                fName = sprintf('%s_square_%us_%ut.txt',...
                    char(obj.spectralClass), obj.stepTime, obj.totalTime);
            end
        end
    end
