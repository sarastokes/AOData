classdef PulseChirp < patterson.protocols.spectral.Chirp
% PULSECHIRP
%
% Description:
...
% -------------------------------------------------------------------------
    ...
    methods
        function obj = PulseChirp(calibration, varargin)
            obj = obj@patterson.protocols.spectral.Chirp(...
        ...
        function stim = generate(obj)
            stim = generate@patterson.protocols.spectral.Chirp(obj);
