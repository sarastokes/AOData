...
obj = aod.core.Experiment('name', experimentDate, 'homeDirectory',...
	'Administrator', 'YourName', 'System', 'Primate1P')
		...
		\begin{itemize}
			...
			\item \aodfcn{add(obj, entity)} - add Analysis, Calibration, Epoch, Annotation, Source or System\\
			%
			...
			%
			\item \aodfcn{removeAnnotation(obj, ID)}
			\item \aodfcn{clearAnnotation(obj)}\\
			%
