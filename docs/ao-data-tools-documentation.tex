...
obj = aod.core.Entity(name)
		...
		\begin{itemize}
			...
			\item \aodprop{UUID} - a randomly-generated unique identifier from \aodfcn{aod.infra.UUID.generate()}. Behind the scenes, these are used to search through entities and their HDF5 counterparts, providing a solution for indexing which is one of HDF5's larger shortcomings. See \myurl{\ref{subsubsection:EntityManager}} on \aodclass{aod.h5.EntityManager} for the solution.
		\end{itemize}
