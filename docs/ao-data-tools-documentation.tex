...
addpath(genpath('yourfilepath/ao-data-tools'))
		...
		\end{itemize}
		%I'm happy to help get you started with git - 
...
obj = aod.core.Epoch(ID)
		...
		\begin{itemize}
			...
			% \item \aodfcn{addDataset(obj, dataset)}
			% \item \aodfcn{addResponse(obj, response)}
			% \item \aodfcn{addRegistration(obj, registration)}
			% \item \aodfcn{addStimulus(obj, stimulus)}
