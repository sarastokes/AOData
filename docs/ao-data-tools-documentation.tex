...
classdef MyFactory < aod.util.Factory
	...
	\subsection{aod.util.ParameterManager \myparent{handle}}
		...
		Each AOData class inheriting from \aodclass{aod.core.Entity} has a dependent property called \aodprop{expectedParameters}, which is set by the output of the function \aodfcn{getExpectedParameters}. 
